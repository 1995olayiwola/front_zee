                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <ul className="footer-ul">
                            ...
                            <li className="d-flex">
                                <div className="footer-info-item" ><i className="fas fa-envelope"></i></div> <span>zeegoldinvestmentlimited@yahoo.com</span>
                            </li>
                            <li className="d-flex">
                                <div className="footer-info-item"><i className="fas fa-map-marker-alt"></i></div> <span>KLM 49 Lekki Epe Expressway,Lagos. </span>
                            </li>
                            <li className="d-flex">
                                <div className="footer-info-item"><i className="fas fa-phone-alt"></i></div> <span>07025001968</span>
                            </li>
                        </ul>
                    </div>
                    {/*<div className="col-lg-3 col-md-6">
